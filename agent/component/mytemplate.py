...
class MytemplateParam(ComponentParamBase):
    """
    ...
    def check(self):
        self.check_empty(self.content, "[Mytemplate] Content")
        return True


class Mytemplate(ComponentBase):
    component_name = "Mytemplate"
    ...
    def _run(self, history, **kwargs):
        ...
        return Mytemplate.be_output(content)
